...
var draggable = (node, options = {}) => {
  let {
    ...
    handle,
    touchAction = "none",
    defaultClass = "neodrag" /* MAIN */,
    defaultClassDragging = "neodrag-dragging" /* DRAGGING */,
    defaultClassDragged = "neodrag-dragged" /* DRAGGED */,
  ...
  return {
    ...
    update: (options2) => {
      ...
      defaultClass = options2.defaultClass ?? "neodrag" /* MAIN */;
      defaultClassDragging = options2.defaultClassDragging ?? "neodrag-dragging" /* DRAGGING */;
      defaultClassDragged = options2.defaultClassDragged ?? "neodrag-dragged" /* DRAGGED */;
      nodeClassList.add(defaultClass);
      if (dragged)
        nodeClassList.add(defaultClassDragged);
      if (isControlled) {
